...
namespace GradeBookTests
{
    public class UpdateGPACalculationsToSupportWeightedGPATests
    {
        ...
        public void GetWeightedGPATest()
        {
            ...
            Assert.True((double)method.Invoke(gradeBook, new object[] { 'A', StudentType.Standard }) == 4, "`GradeBook.GradeBooks.BaseGradeBook`'s `GetGPA` method weighted a student's grade even when they weren't an Honors or Dual Enrolled student.");
